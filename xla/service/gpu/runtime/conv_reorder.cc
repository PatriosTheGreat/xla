...
static absl::Status ConvReorderFilterImpl(
  ...
  auto executed = run_options->stream()->PrepareInputsForVectorizedConvolution(
...
static absl::Status ConvReorderFilterAndBiasImpl(
    const ServiceExecutableRunOptions* run_options,
