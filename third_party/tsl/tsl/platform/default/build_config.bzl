    ...
    native.cc_test(
        ...
        deps = deps + if_tsl_link_protobuf(
            ...
            [
                ...
                # TODO(jblespiau): An attempt to get //third_party/tensorflow/lite/delegates/flex/test:framework_build_test to build.
                # clean_dep("//tsl/protobuf:status_proto_impl_cc_impl"),
            ],
        ),
        **kwargs
    )
